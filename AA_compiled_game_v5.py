...
class Start:
    def __init__(self, parent):
        ...
        self.adds_funds_button = Button(self.entry_error_frame,
                                        font="Arial 14 bold",
                                        text="Add Funds",
                                        command=self.check_funds)
        self.adds_funds_button.grid(row=0, column=1)

        self.amount_error_label = Label(self.entry_error_frame, fg="maroon",
                                        text="", font="Arial 10", wrap=275,
                                        justify=LEFT)
    ...
    def check_funds(self):
        ...
        # Disable all stake buttons in case user changes mind and
...
class Game:
    ...
    def reveal_boxes(self):
        ...
        print("stats list  in reveal boxes function", self.round_stats_list)
...
class Help:
    def __init__(self, partner):
        ...
        help_text="Choose an amount to play with and then choose the stakes.  " \
                  ...
                  "well.\n\n" \
                  "When you enter the paly area, you will see three mystery " \
                  ...
                  "they contained copper, silver and gold, you would " \
                  "$13 ($1 + $2 + $10 and so on."
...
class GameStats:
    def __init__(self, partner, game_history, game_stats):
        ...
        all_game_stats = [
            "Starting balance: ${:.2f}".format(game_stats[0]),
            "Current balance: ${:.2f}".format(game_stats[1]),
        ]
    ...
    def export(self, game_history, all_game_stats):
        print("game stats list in export function...")
...
class Export:
    def __init__(self, partner, game_history, all_game_stats):
        ...
        print("all game stats", all_game_stats)
    ...
    def save_history(self, partner, game_history, game_stats):
        ...
        self.export_text = Label(self.export_frame, text=self.export_text,
                               justify=LEFT, wrap=400, padx=10, pady=10)
        self.export_text.grid(row=1)
